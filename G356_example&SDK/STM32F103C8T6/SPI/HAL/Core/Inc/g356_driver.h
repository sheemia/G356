...
//
// Wiring (G356 module  ->  STM32F103C8T6 SPI2 Controller peripheral):
//   G356 VCC   -> 3.3V                  (module power, must be stable)
//   G356 GND   -> GND                   (must share ground with the MCU)
//   G356 CS    -> PA2                   (manual chip-select, active low)
//   G356 SCLK  -> PB13 (SPI2_SCK)       (Mode 0: CPOL=0, CPHA=0)
//   G356 MISO  -> PB14 (SPI2_MISO)      (G356 -> MCU, telemetry data)
...
//      hspi2 handle and main.h's GPIO_CS_* macros -- adjust names to match
