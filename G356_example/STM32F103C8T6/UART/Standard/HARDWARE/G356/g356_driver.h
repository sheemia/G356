...
//
// Wiring (G356 module  ->  STM32F103C8T6 UART peripheral):
//   G356 VCC   -> 3.3V                  (module power, must be stable)
//   G356 GND   -> GND                   (must share ground with the MCU)
//   G356 TXD   -> PA3 (USART2_RX)       (G356 -> MCU, telemetry data)
//   G356 RXD   -> PA2 (USART2_TX)       (only needed if you also send
...
// ready. This file has no STM32/HAL dependency at all -- it is pure byte
// processing, portable to any MCU.
//
